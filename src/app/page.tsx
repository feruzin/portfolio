        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            <TimelineItem 
              ...
              subtitle="Mundivox"
              date="06/2024 – Atual"
              description="Configuração de roteadores (Mikrotik, Ubiquiti, Cisco), alocação de portas, ativação de serviços em redes corporativas."
            />
            <TimelineItem 
              title="Estágio em TI"
              subtitle="COHAB Curitiba"
              date="08/2023 – 06/2024"
              description="Suporte ao usuário, manutenção de estações e equipamentos, garantindo o funcionamento contínuo das operações diárias."
            />
            <TimelineItem 
      ...
      <section id="contato" className="py-20 bg-surface border-t border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-12">
            ...
            <a href="tel:+5542988740336" className="flex items-center text-gray-300 hover:text-brand-blue transition-colors">
